...
const postNewInterviewStatus = app.post('/newcandidate', async (req, res) => {
    try {
        ...
        await slackWebhookRequestHandler(req.body.name, req.body.role, req.body.cv, req.body.result, req.body.interviewer, req.body.feedback, req.body.date_time)
        res.json({ message: "Ok" })
    } catch (error) {
        console.log(error)
...
module.exports = postNewInterviewStatus
